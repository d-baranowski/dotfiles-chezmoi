...
export ACCENT=$WHITE
export ACCENT_TRANSPARENT=0x66ffffff # Transparent version of accent

export BAR_COLOR=0x99000000     # Bar background (60% opacity)
...
export BORDER_ACTIVE_COLOR=0xff0076ff
